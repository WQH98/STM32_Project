...
void start_task(void *pvParameters)
{
    ...
    timer1_handler = xTimerCreate("timer1", 5000, pdFALSE, (void*)1, (TimerCallbackFunction_t)led0_reversal);
    my_printf(&uart1_handler, "creat %s %s\r\n", "timer1", (timer1_handler != NULL)? "success" : "failed");

    timer2_handler = xTimerCreate("timer2", 1000, pdTRUE, (void*)2, (TimerCallbackFunction_t)led1_reversal);
    my_printf(&uart1_handler, "creat %s %s\r\n", "timer2", (timer2_handler != NULL)? "success" : "failed");

...
USART3_Data usart3_message = {0, 0, false};
...
void USART3_IRQHandler(void)
{
    ...
    if(__HAL_UART_GET_FLAG(&USART3_Handler, UART_FLAG_RXNE) == SET)
    {
        ...
        usart3_message.rx_buf[usart3_message.rx_len] = receive;
		usart3_message.rx_len++;
		if(usart3_message.rx_len > 199) usart3_message.rx_len = 0;
		__HAL_UART_CLEAR_FLAG(&USART3_Handler, UART_FLAG_RXNE);
    }
	if(__HAL_UART_GET_FLAG(&USART3_Handler, UART_FLAG_IDLE) == SET) 
	{
        usart3_message.rx_finsh = true;
